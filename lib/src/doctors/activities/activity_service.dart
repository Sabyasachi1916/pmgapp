...
class ActivityService {
  ...
  Future<ActivityListModel?> getActivityList(String id, int offset) async {
    
    final SharedPreferences prefs = await _prefs;
    var bearerToken = prefs.getString('token');
    var headers = {'Authorization': 'Bearer $bearerToken'};
    var url = Uri.parse(ApiRequest.BASE_URL +'/api/ActivityLogLead/List/$offset/10?isAsc=false&LeadNumber=$id&length=10');
